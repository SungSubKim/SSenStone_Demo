                        ...
                        <td valign=top>
                           <table id="__03" width="1100" border="0" cellpadding="0" cellspacing="0" valign=top>
                              <tr valign=top>
                                 ...
                                 <td>
                                    <select name="sfl" style="height:28px; width:90px">>
                                       ...
                                       <option value="name" selected>서명자</option>
                                       <option value="authtype">인증TYPE</option>
                                       <option value="authuse">인증용도</option>
                                    </select>
                                 </td>
                              ...
                              <tr valign=top>
                                 ...
                                 <tr valign=top>
                                    <td width="150" align="center">서명자</td>
                                    <td align="center">서명시간</td>
                                    <td align="center">인증 TYPE</td>
                                    <td align="center">인증 용도</td>
                                 </tr>
                                 <tr valign=top>
                                 ...
                                 <% 
                                   ...
                                   try{
                                       ...
                                       String sql = "select SIGNATURE, USERID, AUTHDATETIME, AUTHTYPE, AUTHUSE from tb_sp_authlog "+wheresql+"order by AUTHDATETIME desc limit "+startRow+","+endRow+";";
                                       String totalcntsql = "select count(*) as ORGCARDNUM from tb_sp_votcmembers tsv, tb_sp_votccard_log tsvl where tsvl.UID = tsv.UID " + wheresql + "  order by tsvl.USERNUM desc limit "+startRow+","+endRow+";";
...
.getString("AUTHDATETIME")%>','APPLOGINWIN', 'width=700, height=800, resizable=0, scrollbars=no, status=0, titlebar=0, toolbar=0, left=300, top=200, location=no');">
                                          ...
                                          <td width="180" align="center"><%
                                             String authdatetime = rs.getString("AUTHDATETIME");
                                             out.println(rs.getString("authdatetime"));
                                             %>
                                          </td>
                                          <td width="180" align="center"><%
                                             String authtype = rs.getString("AUTHTYPE");
                                          if(rs.getString("authtype").equals("1"))
                                          {
                                             out.println("PIN인증");
                                          }
                                          else if(rs.getString("authtype").equals("2"))
                                          {
                                             out.println("OTP인증");
                                          }
                                          else if(rs.getString("authtype").equals("8"))
                                          {
                                             out.println("지문인증");
                                          }
                                          else if(rs.getString("authtype").equals("10"))
                                          {
                                             out.println("홍채인증");
                                          }
                                          else if(rs.getString("authtype").equals("20"))
                                          {
                                             out.println("안면인증");
                                          }
                                          else
                                          ...
                                          <td width="180" align="center"><%
                                             String authuse = rs.getString("AUTHUSE");
                                             out.println(rs.getString("authuse"));
                                             %>
                                          </td>
                                    </tr>
                                    <tr valign=top>
